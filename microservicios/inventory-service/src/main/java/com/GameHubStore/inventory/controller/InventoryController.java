...
public class InventoryController{
    ...
    @Operation(summary = "Buscar stock por ID", description = "Retorna el registro de stock por su ID")
    @ApiResponses(value = {
    ...
    public ResponseEntity<List<InventoryResponse>> getInventoryByProductId(
    ...
    public ResponseEntity<List<InventoryResponse>> getInventoryByLocation(
